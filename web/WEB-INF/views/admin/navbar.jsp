...
<div class="navbar">
    <div class="navbar-inner">
        ...
        <ul class="nav">
            ...
            <li class="${param.massSearch}"><a href="/admin/view/mass-search">Массовый поиск</a></li>
            <li class="${param.report_calculate}"><a href="/admin/view/report-calculator">Квартальный отчет</a></li>
